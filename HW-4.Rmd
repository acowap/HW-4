...
However, conty lines aren't a very accurate representaion of population. This time, let's weight the distance from each county to the hub by the popultion of the county, so that the number we consider is not just distance, but distance/popultion.
```{r, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, fig.width=8, fig.height=4.5}
#find hub placement
